...
class VideoAnimator():
    def __init__(self, model_path="grid", gpu=-1):
        ...
        if (not os.path.isfile(model_path)):
            download_blob(GCP_BUCKET_NAME,"crema.dat",os.path.split(__file__)[0] + "/data/")
        #download_blob(GCP_BUCKET_NAME,"grid.dat",os.path.split(__file__)[0] + "/data/")
